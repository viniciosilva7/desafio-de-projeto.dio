...
def exibir_extrato(clientes):
    ...
    extrato = ""
    tem_transacao = False
    tipo_filtro = input("Deseja filtrar por tipo de transação? (sim ou não): ")
    tipo_transacao = None
    if tipo_filtro.lower() == "sim":
        tipo_transacao = input("Informe o tipo de transação (Saque/Deposito): ")
